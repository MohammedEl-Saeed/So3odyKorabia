                        ...
                        <form id="main-form-to-add-doctor" class="form" method="post" action="{{route('cities.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="{{old('name')}}"  min="3"  max="100" placeholder="اسم المدينة">
                                </div>
                                <div class="col-md-6">
                                    <label>الاتاحة:</label>
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary ml-2 pull-left">أضافم مدينة جديدة</button>
