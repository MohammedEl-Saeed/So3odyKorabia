                        ...
                        <form id="main-form-to-add-doctor" class="form" method="post" action="{{route('areas.update',$item->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="delivery_time" name="delivery_time" value="{{old('delivery_time',$item->delivery_time)}}"  min="3"  max="100" placeholder="Enter a name">
                                    <span class="form-text text-muted">Please enter delivery time</span>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="delivery_cost">Delivery Cost:</label>
                                    <input type="text" class="form-control" id="delivery_cost" name="delivery_cost" value="{{old('delivery_cost',$item->delivery_cost)}}"  min="3"  max="100" placeholder="Enter a name">
